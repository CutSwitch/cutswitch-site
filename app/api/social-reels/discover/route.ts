...
export async function POST(req: Request) {
  ...
  try {
    ...
    return noStoreJson({
      ...
      generation_summary: result.durationFirstManifest?.generation_summary,
      ...
      response_schema: result.durationFirstManifest ? "duration_first_manifest" : result.matrixResponse ? "discovery_matrix" : "candidates",
      usage: result.usage,
