...
- The live shortlist prompt asks only for reduced-schema fields. Heavy enrichment fields such as `title_options` are reserved for a later full/enrichment pass.
