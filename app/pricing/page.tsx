...
export const metadata: Metadata = {
  title: "Pricing",
  description:
    "Choose a plan. Start a 7-day trial on subscriptions. Stripe Tax is calculated automatically.",
};

export default function PricingPage() {
  return (
    <div className="container-edge">
      {/* Align the heading block with the card content below */}
      <div className="pl-1 sm:pl-2">
        ...
        <div className="mt-12 rounded-2xl border border-line bg-surface-2 p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-white/65">
            We keep pricing straightforward and the policy clear: all purchases
            are final. This reduces support loops, eliminates refund churn, and
            lets us focus on shipping. If something is broken, Support will help
            you.
          </p>
