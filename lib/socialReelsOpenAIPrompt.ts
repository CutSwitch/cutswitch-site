...
export const SOCIAL_REELS_EDITORIAL_SYSTEM_PROMPT = [
  ...
  "Use duration window quality metadata as a guide, not as a replacement for editorial judgment. Prefer windows with standalone Question -> Tension -> Answer -> Reframe shape, clear tension, confession, practical lesson, emotional turn, reframe, payoff, or a specific claim. Avoid windows marked as intro_setup, outro_logistics, podcast_wrapup, product_promo, sponsor_or_ad, book_link_outro, follow_up_logistics, meta_editing, mic checks, technical setup, pre-show chatter, dead air, or filler unless the requested style explicitly requires that material.",
