  ...
  return (
    <div className="container-edge">
      <SectionHeading
        ...
        subtitle="If something is broken, confusing, blocking you, or you need help with a privacy/data request, tell us. In the app you can export a Cut Plan JSON via File → Export → Export Cut Plan (JSON)… so we can fix issues faster."
      />
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-white/65">
            Drop a note here and we’ll reply ASAP. Use the privacy topic for access, deletion, correction, or opt-out requests. Including a Cut Plan JSON helps with app troubleshooting.
          </p>
